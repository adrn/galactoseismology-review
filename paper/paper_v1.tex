...
% prefer to write summary statements, and then use \cite{...} as the reference
...
The distance measurements are from photometry alone and have expected absolute uncertainties of $\approx$20\% \cite{sheffield14}.
}
\end{figure}
...
% KVJ: I just added a couple of sentences. Don't want seciton too long
...
...
[Ti/Fe] lower by up to 0.4 dex compared to the mean trends known for main-sequence stars of the Galactic disk (e.g Reddy et al. 2003, Bensby et al. 2014) and a mean offset for [Y/Fe] of about 0.2 dex at [Fe/H] $\approx -0.5$. A comparison with results from the same group for stars in the Sgr dwarf spheroidal galaxy \cite{chou2010a} suggested more similar patterns to those seen in Mon/GASS and support  an external origin for this structure. Subsequent work comes to similar conclusions for the TriAnd Clouds \cite{chou11}.
...
We find that stars in the TriAnd 1 and in A13 overdensities have extremely similar chemical abundances, with the abundance dispersion $\leq 0.06$ dex for most chemical elements. The TriAnd 1 and A13 stars also have a very narrow metallicity spread,  [Fe/H] $= -0.92 \pm 0.06$ dex. The abundances of all measured alpha-elements are uniformly enhanced at the level of 0.43 $\sim$ 0.06 dex for [O/Fe], 0.41 $\sim$ 0.02 dex for [Mg/Fe], $0.35 \pm 0.06$ dex for [Na/Fe], and 0.15 $\sim$ 0.03 dex for [Eu/Fe] (Figure 1). At this level, the TriAnd 1 and A13 stars are consistent with the abundances of the in-situ formed Milky Way thick disk stars \cite{fuhrmann2002,bergemann2014,bensby2014}.
...
A paper describing this work is currently in preparation (Bergemann et al, 2017).
...
Infrared surveys, such as APOGEE \cite{}, could overcome this limitation and reach entirely across the Galaxy. Spectra from such a survey could provide both motions and abundance patterns.
...
Preliminary arguments for the existence of this ``kicked-out-disk'' population were based on transitions in the density or orbital structures of stellar halos \cite[e.e.][]{carollo07}.
