...
% APW COMMENT: I think your reference "jurie17" should be "lurie17" -- maybe
% combined John Lurie's last name with Mario Juric's?
...
% APW COMMENT: this section makes it sound like the surveys discovered these things "for free," but really it was the authors you cite who found these things. I would rearrange to say, e.g., "Using data from the \survey{Hipparcos} mission \citep{esa97}, moving groups of stars were found in the velocity distribution in the Solar Neighborhood \citep{dehnen98}...etc"
...
% APW COMMENT: If the sections are reorganized to be by structure instread,
